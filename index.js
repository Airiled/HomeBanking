...
function historialTransacciones(user) {
    ...
    console.log('entre a la funcion bien');
    console.log(longitudHistorial);
    ...
    console.log('estoy saliendo de la funcion');
    menuDelUsuario(user);
}
...
function transferirAOtroUsuario(user) {
    ...
    let cuentaDestino;
    console.log(escalaTipoDeCuenta);
    ...
    console.log(typeof(userDestino.cuentas[escalaTipoDeCuenta]));
